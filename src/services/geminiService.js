...
${welcomeLength}`;
    ...
    const fallbackWelcomes = {
      ...
      lifestyle: "Welcome! I'm so thrilled to embark on this wellness journey with you.*Built for Makeathon Competition by Alina Izma.Z and her buddy*, this chatbot helps as a lifestyle and wellness coach, I draw on expertise in nutrition, fitness, mental health, and sleep science to help you create sustainable, positive change. Let's work together to achieve your unique goals – tell me, what are you hoping to achieve for your wellbeing?"
    };
